...
INTEGER, PARAMETER :: numoutputfiles=24
...
CHARACTER(len=256)::fileRoute, waterDir, outputDir, inputYear, paramfile !Arg name
...
nyears=2
IF (narg .gt. 0) THEN
	call GET_COMMAND_ARGUMENT(1, fileRoute)
	fileRoute= fileRoute(:LEN_TRIM(fileRoute))
	if(narg .gt. 1) then
	    call GET_COMMAND_ARGUMENT(2, waterDir)
	    waterDir= waterDir(:LEN_TRIM(waterDir))
	    waterDir=trim(waterDir)//'/'
	    if(narg .gt. 2) then
	        call GET_COMMAND_ARGUMENT(3, outputDir)
	        outputDir= outputDir(:LEN_TRIM(outputDir))
	        outputDir=trim(outputDir)//'/'
	        if(narg .gt. 3) then
	            call GET_COMMAND_ARGUMENT(4, inputYear)
...
if(narg .gt. 4) then
    call GET_COMMAND_ARGUMENT(5, paramfile)
...
! Read parameters from tabular file
SUBROUTINE read_parameter_data(paramfile)
    USE physicalenv
    USE preybase
    USE species
    USE indivattributes
    ...
    USE random
    integer :: ii
    character(len=60) :: paramfile
    REAL(8) :: inputargs(8)
    INTEGER, PARAMETER:: openfiledescriptor = 260
    OPEN (openfiledescriptor, file = paramfile, STATUS = 'UNKNOWN')
    READ (openfiledescriptor, *) RM1, RM2, M1, M2, M3, IA1, IA2, IA3, IC1, IC2, IC3
    READ (openfiledescriptor, *) (inundationdays(ii),ii=1, inundationtimestamps)
	READ (openfiledescriptor, *) (inundationhours(ii),ii=1, inundationtimestamps)
	READ (openfiledescriptor, *) (speciesid(ii),ii=1, nfwsp)
	READ (openfiledescriptor, *) minfeedhr, maxfeedhr
    READ (openfiledescriptor, *) (fileflag(ii),ii=1, numoutputfiles)
    READ (openfiledescriptor, *) (watsched(ii),ii=1, waterschedyrs)
	READ (openfiledescriptor, *) zerolevel, addwater, minprob, maxSAV, minworth 
	READ (openfiledescriptor, *) inundmax, calorcoeff, cellmax, cellsize, idum
	READ (openfiledescriptor, *) pdfa
	READ (openfiledescriptor, *) pdfb
	READ (openfiledescriptor, *) pdfc
	READ (openfiledescriptor, *) pdfd
	READ (openfiledescriptor, *) pdfe
	READ (openfiledescriptor, *) indpreywght
	READ (openfiledescriptor, *) initpreynum
	READ (openfiledescriptor, *) preyenerden
	DO j=1, preytypes
	    READ (openfiledescriptor, *) (preymult(j,ii),ii=1,habtype)
	END DO 
	READ (openfiledescriptor, *) spposn
	DO j=1, nfwsp
	    READ (openfiledescriptor, *) (earlymort(ii,j),ii=1, 3)
	END DO
	DO j=1, nfwsp
	    READ (openfiledescriptor, *) (mortmult(j,ii),ii=1, habtype)
	END DO
	DO j=1, nfwsp
	    READ (openfiledescriptor, *) (preyv(j,ii),ii=1, preytypes)
	END DO
	DO j=1, nfwsp
	    READ (openfiledescriptor, *) (preyk(j,ii),ii=1, preytypes)
	END DO
	READ (openfiledescriptor, *) (cmaxscalar(j),j=1, nfwsp)
	READ (openfiledescriptor, *) (cmaxexpo(j),j=1, nfwsp)
	READ (openfiledescriptor, *) (cmaxoptt(j),j=1, nfwsp)
	READ (openfiledescriptor, *) (cmaxmaxt(j),j=1, nfwsp)
	READ (openfiledescriptor, *) (cmaxtheta(j),j=1, nfwsp)
	READ (openfiledescriptor, *) (pvalue(j),j=1, nfwsp)
	READ (openfiledescriptor, *) (egscalar(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (egexpo(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (exscalar(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (sdascalar(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (respscalar(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (respexpo(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (respoptt(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (respmaxt(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (resptheta(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (act(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (predenerden(j),j=1, nfwsp)
	DO j=1, nfwsp
	    READ (openfiledescriptor,*) (initwt(j,ii),ii=1, 2)
	END DO
	
	READ (openfiledescriptor,*) (metmorphwt(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (lw_scalar(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (lw_expo(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (matlen(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (breedtype(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (minspwnday(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (maxspwnday(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (feca(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (fecb(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (fecc(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (batches(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (eggwght(j),j=1, nfwsp)
	DO j=1, nfwsp
	    READ (openfiledescriptor,*) (fracta(j,ii),ii=1, 3)
	END DO
	DO j=1, nfwsp
	    READ (openfiledescriptor,*) (fractc(j,ii),ii=1, 3)
	END DO
	READ (openfiledescriptor,*) (nhood(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (emermult(j),j=1, nfwsp)
	READ (openfiledescriptor,*) (fiterror(j),j=1, nfwsp)
